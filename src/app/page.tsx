    ...
    <div className="bg-slate-50">
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            <img src="/snake-2.png" className="w-24 lg:order-1 order-0" />
          </div>
          <div
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20 ">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  <span>image is super clear</span>,on the case I had
                  before,image started fading into yellow-ish color after a
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20 ">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  on the corner,
                  <span> looks brand new after about a year.</span> I dig it."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          <div className="mg-12 px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              />
              <div
                className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10
              lg:rounded-2xl"
              >
                <img
                  src="/horse.jpg"
                  className="rounded-md mt-3 object-cover bg-white shadow-2xl ring-1 ring-gray-900/10 h-full w-full"
                />
              </div>
