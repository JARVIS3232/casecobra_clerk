        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We are preparing everything for your delivery and will notify you
              once your package has been shipped. Delivery usually takes 2 days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any quetions regarding your order,please feel free to
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you have any question.(if you reply to this
